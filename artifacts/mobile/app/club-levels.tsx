...
const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    ...
    copy: "Learn real digital skills, earn XP, and grow consistently without sacrificing school.",
    color: "#D4387C",
    icon: "book"
  },
  {
    ...
    bestFor: "Students who want learning + networking + collaboration.",
    ...
    copy: "Learn, connect, and collaborate with ambitious students building real careers.",
    color: "#8B5CF6",
    icon: "users"
  },
  {
    ...
    bestFor: "Students who want premium access and elite opportunities.",
    ...
    features: [
      ...
      "Future Talent Placement",
      "Exclusive Merchandise"
    ],
    copy: "Go beyond online learning with real-world access and elite networking.",
    color: "#F59E0B",
    icon: "award"
  }
];
