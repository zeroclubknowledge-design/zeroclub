  ...
  const tabs = (
    ...
    >
      ...
      <Tabs.Screen 
        name="bootcamps" 
        options={{ 
          // Only show in the default tab bar if not a tutor
          href: !isTutor ? "/bootcamps" : null 
        }} 
      />
      ...
      <Tabs.Screen 
        name="studio" 
        options={{ 
          // Only show in the default tab bar if a tutor
          href: isTutor ? "/studio" : null 
        }} 
      />
...
export default function TabLayout() {
  // Use the robust Classic layout across all platforms (Web, iOS, Android) 
  // to ensure 100% stable routing and avoid experimental 'unstable-native-tabs' errors.
